...
// 왜 이 튜토리얼인가?
// Redux를 익혀오며, 나는 읽었던 글들과 개인적 경험들에서 잘못된 지식을 축적해왔다는걸 느꼈다.
// I don't mean that articles about flux are not well written
// flux에 관한 그 글들이 잘 못 쓰였다는 의미는 아니고, 내가 개념을 정확히 받아들이지 못했다.
// but I just didn't grasp concepts correctly. In the end, I was just applying documentation of different
// 결국, 나는 그저 다른 문서들을 적용하였다
